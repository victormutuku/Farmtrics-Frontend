...
return [
    'Pricing for Every Business, at Any Stage'=>'Pricing for Every Business, at Any Stage',

    'Estimate your monthly cost' => 'Estimate your monthly cost',
    'Pricing is based on the number of mobile users and data collection forms' => 'Pricing is based on the number of mobile users and data collection forms' ,
    ...
    '$8/mobile user/month' => '$8/mobile user/month',
    '$20/mobile user/month' => '$20/mobile user/month',
    ...
    '15 users minimum' => '15 users minimum',
    'More than 100 users?' => 'More than<br/>100 users?',

    'Mobile app with offline sync' => 'Mobile app with offline sync',
    'Drag-and-Drop Workflow Builder' => 'Drag-and-Drop Workflow Builder',
    'Geo-stamped data' => 'Geo-stamped data',
    'Mobile and web reports' => 'Mobile and web reports',
