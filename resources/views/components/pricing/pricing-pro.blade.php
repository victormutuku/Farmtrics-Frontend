<div class="mx-10 my-5 sm:mx-5 sm:my-0 hover:rounded-3xl hover:bg-green-100 h-[500px] py-5 min-w-fit max-w-[300px] flex flex-col items-center md:px-5">
    <h1 class="font-bold text-xl">
     ...
     <div class="px-10">
         <ul class="list-outside list-disc">
             ...
             <li class="break-normal">{{ __('pricing.Availability of farmer\'s identities') }}</li>
         </ul>
     </div>
