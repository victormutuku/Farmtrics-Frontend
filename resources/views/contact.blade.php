...
@section('content')
    ...
    <div class="flex justify-center mb-[200px]">
        ...
        <form action="#" method="POST" class="w-[470px] ml-[80px] flex flex-col items-end">
            ...
            <input placeholder="Full Name" type="text" name="fullName" class="border-none placeholder:text-forestgreen mb-6 border-2 py-4 pl-4 rounded-2xl w-full focus:outline-none focus:border-forestgreen " required>
            
            <input placeholder="Business Name" type="text" name="businessName" class="border-none placeholder:text-forestgreen  mb-6 border-2 py-4 pl-4 rounded-2xl w-full focus:outline-none focus:border-forestgreen" required>
            ...
            <textarea placeholder="Add a note" type="text" name="note" class="border-none  placeholder:text-forestgreen mb-8 border-2 py-4 pl-4 rounded-2xl w-full focus:outline-none focus:border-forestgreen" required rows="6"></textarea>
